...
namespace ATLAS {
	Vector3f::Vector3f(real32 x, real32 y, real32 z)
	{
		this->x = x;
		this->y = y;
		this->z = z;
	...
	Vector3f &Vector3f::operator*=(const Matrix3f &rhs)
	{
		*this = rhs * *this;
		return *this;
	}
	...
	Vector3f &Vector3f::operator*=(const real32 &rhs)
	{
		x *= rhs;
		y *= rhs;
		z *= rhs;
	...
	Vector3f operator*(Vector3f lhs, const Matrix3f &rhs)
	{
		return Vector3f(
			lhs.x * rhs.a2[0][0] + lhs.y * rhs.a2[1][0] + lhs.z * rhs.a2[2][0],
			lhs.x * rhs.a2[0][1] + lhs.y * rhs.a2[1][1] + lhs.z * rhs.a2[2][1],
			lhs.x * rhs.a2[0][2] + lhs.y * rhs.a2[1][2] + lhs.z * rhs.a2[2][2]
		);
	}
	Vector3f operator*(const Matrix3f &lhs, const Vector3f &rhs)
	{
		Vector3f result =
		{
			lhs.a2[0][0] * rhs.x + lhs.a2[0][1] * rhs.y + lhs.a2[0][2] * rhs.z,
			lhs.a2[1][0] * rhs.x + lhs.a2[1][1] * rhs.y + lhs.a2[1][2] * rhs.z,
			lhs.a2[2][0] * rhs.x + lhs.a2[2][1] * rhs.y + lhs.a2[2][2] * rhs.z
		};
...
namespace ATLAS {
	...
	Vector4f::Vector4f(Vector3f vec, real32 w)
	{
		this->x = vec.x;
		this->y = vec.y;
		this->z = vec.z;
